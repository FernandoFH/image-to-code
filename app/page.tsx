...
export default function Home() {
	...
	return (
		<div className="grid grid-cols-[400px_1fr]">
			<aside className="flex flex-col justify-between min-h-screen p-10 bg-gray-900">
				<header className="text-center">
					<h1 className="text-3xl font-semibold">Image 2 Code</h1>
					<h2 className="text-sm opacity-75">Pasa Imagenes a Codigo en Segundos</h2>
				</header>

				<section>{/* Aqui iran los filtros...*/}</section>

				<footer className="text-center text-sm opacity-75">Dev MiduDev</footer>
			</aside>
